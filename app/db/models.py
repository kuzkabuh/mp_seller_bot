# Версия файла: 2.1.0
# Описание: ORM-модели для mp_seller_bot (пользователи, учётные записи МП, события заказов).
#           Добавлена колонка users.updated_at для совместимости со схемой и обновлениями.
...
class User(Base):
    ...
    #: Дата последнего обновления записи (нужна для совместимости и сервисных задач)
...
class OrderEvent(Base):
    ...
    #: Внешний идентификатор заказа/отправления
